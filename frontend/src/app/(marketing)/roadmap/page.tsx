...
const PHASES = [
  ...
  },
  {
    ...
    period: 'Q1–Q2 2026',
    items: [
      'Next.js 16 App Router DApp — 24 routes built',
      'RainbowKit wallet integration (MetaMask, WalletConnect)',
      'Staking, vesting, governance, treasury, analytics, admin UI',
      'Real-time blockchain data via wagmi v2',
      'Admin panel with role-gated emergency controls',
      'Dark/light mode — full mobile responsive design',
    ],
  },
  {
    phase: 'Phase 3',
